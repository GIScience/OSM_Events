...
public class Mapping_Event {
	...
	public Mapping_Event(OSHDBTimestamp t, Integer users, Integer contributions, Integer max_contribution, Float change, HashMap<ContributionType, Integer> types_count) {
		this.t = t;
		this.users = users;
